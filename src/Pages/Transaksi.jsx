...
export default function Transaksi() {
    ...
    let getList = () => {
        let endpoint = `http://localhost:8080/transaksi`;

        axios.get(endpoint, authorization).then((result) => {
            setList(result.data.transaksi);
        ...
        <div className="row col-lg-12">
            ...
            <div className="col-lg-10 mt-4">
                <div className="ms-4 me-2 cardContent">
                    <div className="p-4">
                        <h1 className="fw-bold">Transaksi</h1>
                                ...
                                <ul className="list-group list-group-flush mt-2">
                                    <li className="list-group-item ms-2 p-4 rounded-4"
                                        ...
                                        <div className="row">
                                            ...
                                            <div className="col-md-3 mx-auto align-items-center">
                                                <h6 className="text-custom">
                                                    {item.tgl_transaksi} </h6>
                                            </div>
                                            <div className="col-md-1 mx-auto align-items-center">
